class Creds():
    ...
    TG_TOKEN = "1959633255:AAHVqeTrl52EPJimDtWpMINLyWE-BVz7Q-0"
    ...
    TEAMDRIVE_FOLDER_ID = "1y5-gXhzUEjNlwjAZuFMhX8NtAIvvfsNB"
    
    # Id of Team drive 
    TEAMDRIVE_ID = "1y5-gXhzUEjNlwjAZuFMhX8NtAIvvfsNB"
